...
datos_categoria_AQI_excel <- list("Bueno" = Good <-Datos_calidad_aire |> 
    ...
    "Insalubre"= Unhealthy <- Datos_calidad_aire |> 
    ...
    "No saludable" = No_saludable <- Datos_calidad_aire |> 
...
write_xlsx(datos_categoria_AQI_excel,path = "datos/colegios_limpia_y_sin_procesar.xlsx")
